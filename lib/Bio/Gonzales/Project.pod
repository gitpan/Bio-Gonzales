...
Create it with C<< gonzp add <analysis_name> >>
...
The analysis version is integral part of L<Bio::Gonzales::Project> and therefore accessible via
...
=item Via an exported function of L<Bio::Gonzales::Project>, B<< nfi($filename) >>
...
=item Via an exported variable of L<Bio::Gonzales::Project>, B<< $ANALYSIS_VERSION >>
...
The configuration is stored in C<gonzconf.yml> and accessible via commandline
...
L<Bio::Gonzales::Project> comes with logging included. The logged info is
...
L<Bio::Gonzales::Project> exports the function C<gonzlog> by default. To log stuff you run
